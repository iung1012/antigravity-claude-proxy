...
window.translations.id = {
    ...
    loginTitle: "Autentikasi Diperlukan",
    loginDesc: "Masukkan password Web UI Anda untuk melanjutkan.",
    loginPassword: "Password",
    loginPasswordPlaceholder: "Masukkan password...",
    loginButton: "Masuk",
    loginInvalidPassword: "Password salah",
    loginConnError: "Kesalahan koneksi. Coba lagi.",
    logout: "Keluar",
    ready: "SIAP",
    depleted: "Habis",
    timeH: "j",
