...
window.translations.pt = {
    ...
    loginTitle: "Autenticação Necessária",
    loginDesc: "Digite sua senha do Web UI para continuar.",
    loginPassword: "Senha",
    loginPasswordPlaceholder: "Digite a senha...",
    loginButton: "Entrar",
    loginInvalidPassword: "Senha inválida",
    loginConnError: "Erro de conexão. Tente novamente.",
    logout: "Sair",
    ready: "PRONTO",
    depleted: "Esgotado",
    timeH: "H",
